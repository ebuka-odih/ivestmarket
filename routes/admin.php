...
Route::group(['middleware' => ['auth', 'verified', 'admin'], 'prefix' => 'admin', 'as' => 'admin.'], function(){
    ...
    Route::get('withdrawal/details/{id}', "Admin\AdminWithdraw@withdrawDetails")->name('withdrawDetails');
    ...
    Route::post('updateDate', "Admin\AdminWithdraw@updateDate")->name('updateDate');
    ...
    Route::get('top-wallet', "Admin\AdminWalletController@fundWallet")->name('fundWallet');
    Route::post('top-wallet', "Admin\AdminWalletController@topUpWallet")->name('topUpWallet');
});
