...
{{--    <script src="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/js/all.min.js" integrity="sha512-Tn2m0TIpgVyTzzvmxLNuqbSJH3JP8jm+Cy3hvHrW7ndTDcJ1w5mBiksqDBb8GpE2ksktFvDB/ykZ0mDpsZj20w==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>--}}
    ...
    <script src="//code.jivosite.com/widget/h2RyTnZwze" async></script>
    ...
    <header class="main-header">
        <div class="d-flex align-items-center logo-box pl-20">
            ...
            <a href="{{ route('index') }}" class="logo">
                <!-- logo-->
                <div class="logo-lg">
                    <h3 class="mt-3" style="font-weight: bolder; color: #1288c9 !important">{{ env('APP_NAME') }}</h3>
...
{{--                        </li>--}}
   ...
   @yield('content')
    ...
    <footer class="main-footer">
        ...
        &copy; 2020 <a href="https://www.Scalpstationpro.com/">Scalpstationpro</a>. All Rights Reserved.
    </footer>
